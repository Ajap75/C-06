...
Base* generate(void)
{
    ...
    std::cout << "Result = " << random << std::endl;
...
int main (void)
{
    ...
    std::cout << "An object of class A, B, or C has benn generated (parent class = Base class)" << std::endl;
